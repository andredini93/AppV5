...
import { UnsupportedChartError } from '../erros/unsupported-chart.error';
import { UnformattedChartError } from '../erros/unformatted-chart.error';
...
export class ReportService {
  ...
  getReport(savedReport: any): Observable<any> {
	...
	executeReport(definition) {
		let url = `gdc/projects/${this.session.projectId}/execute`;
		let body = {
			report_req: {
